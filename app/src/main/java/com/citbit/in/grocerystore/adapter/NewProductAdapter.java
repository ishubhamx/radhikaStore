package com.citbit.in.grocerystore.adapter;
...
import com.citbit.in.grocerystore.activity.ProductViewActivity;
import com.citbit.in.grocerystore.interfaces.AddorRemoveCallbacks;
import com.citbit.in.grocerystore.model.Cart;
import com.citbit.in.grocerystore.model.Product;
import com.citbit.in.grocerystore.util.Utils;
...
import static com.citbit.in.grocerystore.activity.BaseActivity.TAG;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                Log.d("cartLisy",""+ cartList.get(i).getId());
