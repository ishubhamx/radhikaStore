...
import com.citbit.in.grocerystore.adapter.ProductAdapter;
...
public class ProductActivity extends BaseActivity {
    ...
    private void getCategoryProduct() {
        showProgressDialog();
        Call<ProductResult> call = RestClient.getRestService(getApplicationContext()).getCategoryProduct(user.getToken(), category);
